...
with st.columns([1,3,1])[1]:
    ...
    st.subheader('Step 1: Upload your java projects and tests (Optional: and mapping file)')
    st.image(img1, use_column_width=True)
    st.write('The mapping file needs to be a CSV file with the following format (Any headers can be used):')
